...
class BuildExe:
    def __init__(self):
        ...
        self.extra_datas = ["img","maps","fonts"]

        #Extra/excludes python modules
        self.extra_modules = ["duck_kogs","duck_kogs.loops","duck_kogs.sprites"]
        self.exclude_modules = []

        #DLL Excludes
        self.exclude_dll = ['']
        #python scripts (strings) to be included, seperated by a comma
        self.extra_scripts = ["pysignals","pygame","random","sys"]
